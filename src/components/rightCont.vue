...
export default {
    ...
    data() {
      return {
        ...
        infoTopIndex: 0,
        homeManageInfo: {},
        infoTop: {title: '近期警情记录', homeManageInfo: this.homeManageInfo, haveInfo: true, showNext: true, showClose: false, showsolt: false, infoArr: [{title: '报警时间', key: 'alarmTime', val: '无', showColor: false, showHead: true, showtitle: true}, {title: '报警设备类型：', key: 'facilityType', val: '无', showColor: true, showHead: false, showtitle: true}, {title: '报警设备场所：', key: 'placeName', val: '无', showColor: true, showHead: false, showtitle: true}, {title: '报警设备位置：', key: 'placeAddress', val: '无', showColor: false, showHead: false, showtitle: true}, {title: '警情类型：', key: 'fConfirmState', val: '无', showColor: true, showHead: false, showtitle: true}]},
        infoBottom: {title: '相关场所信息', haveInfo: false, showNext: false, showClose: false, showsolt: false, infoArr: [{title: '', key: 'fAreaName', val: '无', showColor: true, showHead: false, showtitle: false}, {title: '负责人：', key: 'fVillagePrincipal', val: '无', showColor: false, showHead: false, showtitle: true}, {title: '负责人电话：', key: 'fVillagePhone', val: '无', showColor: false, showHead: false, showtitle: true}, {title: '紧急联系人：', key: 'fAreaPrincipal', val: '无', showColor: false, showHead: false, showtitle: true}, {title: '紧急联系人电话：', key: 'fAreaPhone', val: '无', showColor: false, showHead: false, showtitle: true}, {title: '场所地址：', key: 'fAreaAddress', val: '无', showColor: false, showHead: false, showtitle: true}]},
        WarningTaskList: [],
        placeSelected: '1',
        placeValue: '',
        likeSearchList: [],
